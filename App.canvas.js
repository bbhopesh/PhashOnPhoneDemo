...
export default class App extends Component {
  handleImageData(canvas) {
    ...
    context.getImageData(0, 0, 100, 100).then(imageData => {
      ...
      // console.log(`Data: ${(JSON.stringify(imageData.data, null, 2)).substring(0,100)}`);
      ...
      console.log(data.slice(39996,40000));
      console.log(`Pixels: ${pixels}`)
      const imgData = new ImageData(canvas, data, 100, 100);
      console.log(`ImageData: ${Object.keys(imgData.canvas)}`)
